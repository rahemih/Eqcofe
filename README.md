...
This repository is the canonical EQCOFE backend source through **Step 52 / A5**, with the remediated A6 backend security gate under canonical verification.

- Last fully closed step: **51 — Analytics & Management Read Models — FINAL GATE PASS**
- Active step: **52 — Backend Final Closure**
- Current candidate gate: **Step 52 / A6 — Backend Security Final Review**
- Next gate after canonical A6 completion: **Step 52 / A7 — Performance & Boundedness Verification**
- Money unit: **Toman**
- Wallet: **not part of the product**
- Node: `>=24.18.1 <25`
- Package manager: `pnpm@11.21.0`
- Latest candidate full runtime regression: **572/572 PASS**
