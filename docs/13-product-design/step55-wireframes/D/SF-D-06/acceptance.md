...
|---:|---|---|---|
| 320px | `progressive` | `SF-D-06--320--progressive--v1.svg` | PASS |
| 1440px | `progressive` | `SF-D-06--1440--progressive--v1.svg` | PASS |
| 320px | `unknown-result` | `SF-D-06--320--unknown-result--v1.svg` | PASS |
| 320px | `timeout` | `SF-D-06--320--timeout--v1.svg` | PASS |
...
- [x] اقدام بازیابی «تلاش کنترل‌شده یا بازگشت به سفارش» bounded است.
