...
|---:|---|---|---|
| 320px | `initial` | `SF-E-04--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-E-04--1440--initial--v1.svg` | PASS |
| 320px | `first-use` | `SF-E-04--320--first-use--v1.svg` | PASS |
| 320px | `filtered` | `SF-E-04--320--filtered--v1.svg` | PASS |
...
- [x] بازیابی «پاک‌کردن فیلتر یا تلاش دوباره» bounded و بدون رکورد تکراری است.
