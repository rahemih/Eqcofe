...
|---:|---|---|---|
| 320px | `validation` | `SF-E-11--320--validation--v1.svg` | PASS |
| 1440px | `validation` | `SF-E-11--1440--validation--v1.svg` | PASS |
| 320px | `pending` | `SF-E-11--320--pending--v1.svg` | PASS |
| 320px | `terminal` | `SF-E-11--320--terminal--v1.svg` | PASS |
...
- [x] بازیابی «اصلاح درخواست یا پیگیری همان پرونده» bounded و بدون رکورد تکراری است.
