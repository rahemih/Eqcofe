...
|---:|---|---|---|
| 320px | `initial` | `SF-E-05--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-E-05--1440--initial--v1.svg` | PASS |
| 320px | `denied` | `SF-E-05--320--denied--v1.svg` | PASS |
| 320px | `terminal` | `SF-E-05--320--terminal--v1.svg` | PASS |
...
- [x] بازیابی «بررسی وضعیت یا تماس با پشتیبانی با مرجع» bounded و بدون رکورد تکراری است.
