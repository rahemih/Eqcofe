...
|---:|---|---|---|
| 320px | `first-use` | `SF-E-03--320--first-use--v1.svg` | PASS |
| 1440px | `first-use` | `SF-E-03--1440--first-use--v1.svg` | PASS |
| 320px | `conflict` | `SF-E-03--320--conflict--v1.svg` | PASS |
| 320px | `failed` | `SF-E-03--320--failed--v1.svg` | PASS |
...
- [x] بازیابی «دریافت نسخه تازه یا تلاش دوباره» bounded و بدون رکورد تکراری است.
