...
|---:|---|---|---|
| 320px | `validation` | `SF-E-12--320--validation--v1.svg` | PASS |
| 1440px | `validation` | `SF-E-12--1440--validation--v1.svg` | PASS |
| 320px | `pending` | `SF-E-12--320--pending--v1.svg` | PASS |
| 320px | `terminal` | `SF-E-12--320--terminal--v1.svg` | PASS |
...
- [x] بازیابی «اصلاح داده یا پیگیری همان پرونده» bounded و بدون رکورد تکراری است.
