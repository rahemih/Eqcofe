...
|---:|---|---|---|
| 320px | `first-use` | `SF-E-06--320--first-use--v1.svg` | PASS |
| 1440px | `first-use` | `SF-E-06--1440--first-use--v1.svg` | PASS |
| 320px | `partial` | `SF-E-06--320--partial--v1.svg` | PASS |
| 320px | `server-validation` | `SF-E-06--320--server-validation--v1.svg` | PASS |
...
- [x] بازیابی «تلاش دوباره برای تب ناموفق» bounded و بدون رکورد تکراری است.
