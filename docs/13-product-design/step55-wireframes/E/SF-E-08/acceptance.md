...
|---:|---|---|---|
| 320px | `validation` | `SF-E-08--320--validation--v1.svg` | PASS |
| 1440px | `validation` | `SF-E-08--1440--validation--v1.svg` | PASS |
| 320px | `submitting` | `SF-E-08--320--submitting--v1.svg` | PASS |
| 320px | `conflict` | `SF-E-08--320--conflict--v1.svg` | PASS |
...
- [x] بازیابی «اصلاح فیلد یا رفتن به درخواست موجود» bounded و بدون رکورد تکراری است.
