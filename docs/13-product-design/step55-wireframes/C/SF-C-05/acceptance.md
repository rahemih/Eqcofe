...
|---:|---|---|---|
| 320px | `unauthenticated` | `SF-C-05--320--unauthenticated--v1.svg` | PASS |
| 1440px | `unauthenticated` | `SF-C-05--1440--unauthenticated--v1.svg` | PASS |
| 320px | `submitting` | `SF-C-05--320--submitting--v1.svg` | PASS |
| 320px | `success` | `SF-C-05--320--success--v1.svg` | PASS |
...
- [x] اقدام بازیابی «ورود و ادامه همان اقدام یا تلاش کنترل‌شده» bounded و قابل فهم است.
