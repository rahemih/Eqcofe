...
|---:|---|---|---|
| 320px | `enabled` | `SF-C-03--320--enabled--v1.svg` | PASS |
| 1440px | `enabled` | `SF-C-03--1440--enabled--v1.svg` | PASS |
| 320px | `disabled-with-reason` | `SF-C-03--320--disabled-with-reason--v1.svg` | PASS |
| 320px | `validation` | `SF-C-03--320--validation--v1.svg` | PASS |
...
- [x] اقدام بازیابی «حذف مورد ناسازگار یا یکی از چهار انتخاب» bounded و قابل فهم است.
