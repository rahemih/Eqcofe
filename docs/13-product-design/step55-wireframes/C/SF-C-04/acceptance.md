...
|---:|---|---|---|
| 320px | `initial` | `SF-C-04--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-C-04--1440--initial--v1.svg` | PASS |
| 320px | `first-use` | `SF-C-04--320--first-use--v1.svg` | PASS |
| 320px | `conflict` | `SF-C-04--320--conflict--v1.svg` | PASS |
...
- [x] اقدام بازیابی «حذف مورد ناسازگار و اعتبارسنجی دوباره» bounded و قابل فهم است.
