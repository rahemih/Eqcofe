...
|---:|---|---|---|
| 320px | `initial` | `SF-B-03--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-B-03--1440--initial--v1.svg` | PASS |
| 320px | `no-result` | `SF-B-03--320--no-result--v1.svg` | PASS |
| 320px | `offline` | `SF-B-03--320--offline--v1.svg` | PASS |
...
- [x] اقدام بازیابی «حفظ عبارت و تلاش دوباره» ورودی امن یا پرس‌وجو را حفظ می‌کند.
