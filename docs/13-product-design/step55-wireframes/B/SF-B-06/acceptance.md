...
|---:|---|---|---|
| 320px | `no-result` | `SF-B-06--320--no-result--v1.svg` | PASS |
| 1440px | `no-result` | `SF-B-06--1440--no-result--v1.svg` | PASS |
| 320px | `timeout` | `SF-B-06--320--timeout--v1.svg` | PASS |
| 320px | `failed` | `SF-B-06--320--failed--v1.svg` | PASS |
...
- [x] اقدام بازیابی «پاک‌کردن فیلتر یا بازگشت به دسته‌ها» ورودی امن یا پرس‌وجو را حفظ می‌کند.
