...
|---:|---|---|---|
| 320px | `progressive` | `SF-B-04--320--progressive--v1.svg` | PASS |
| 1440px | `progressive` | `SF-B-04--1440--progressive--v1.svg` | PASS |
| 320px | `out-of-stock` | `SF-B-04--320--out-of-stock--v1.svg` | PASS |
| 320px | `price-changed` | `SF-B-04--320--price-changed--v1.svg` | PASS |
...
- [x] اقدام بازیابی «بازخوانی قیمت و موجودی» ورودی امن یا پرس‌وجو را حفظ می‌کند.
