...
|---:|---|---|---|
| 320px | `initial` | `SF-B-02--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-B-02--1440--initial--v1.svg` | PASS |
| 320px | `filtered` | `SF-B-02--320--filtered--v1.svg` | PASS |
| 320px | `no-result` | `SF-B-02--320--no-result--v1.svg` | PASS |
...
- [x] اقدام بازیابی «پاک‌کردن فیلترهای دسته» ورودی امن یا پرس‌وجو را حفظ می‌کند.
