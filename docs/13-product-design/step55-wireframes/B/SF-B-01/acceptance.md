...
|---:|---|---|---|
| 320px | `initial` | `SF-B-01--320--initial--v1.svg` | PASS |
| 1440px | `initial` | `SF-B-01--1440--initial--v1.svg` | PASS |
| 320px | `progressive` | `SF-B-01--320--progressive--v1.svg` | PASS |
| 320px | `no-result` | `SF-B-01--320--no-result--v1.svg` | PASS |
...
- [x] اقدام بازیابی «مشاهده همه دسته‌ها» ورودی امن یا پرس‌وجو را حفظ می‌کند.
