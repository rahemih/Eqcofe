...
Dashboard is read-only source aggregation; signed integer Toman, no invented cash transfer or global scope guarantee. All actions retain frozen operation authority; no additional runtime or security guarantee is introduced.
