# AD-G-16 — نقش و مجموعه مجوزها

Only permissions/roles/role GET supported; role writes retain NO_ACTION. Existing role list may support staff assignment without granting role edit. All actions retain frozen operation authority; no additional runtime or security guarantee is introduced.
