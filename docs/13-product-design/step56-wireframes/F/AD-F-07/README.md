# AD-F-07 — کمپین و چرخه اجرا

Only list/get/create/pause supported; pause active only with body expected_version, Step-Up and idempotency. Create draft with name, description<=2000 and start<end. Frozen activation/reschedule/end/archive authority gaps remain NO_ACTION.
