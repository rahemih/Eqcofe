# AD-C-02 — گونه‌های کالا

List variants under a known product; distinguish active/inactive from effective sales, edit current version and reconcile through the product variant list.
