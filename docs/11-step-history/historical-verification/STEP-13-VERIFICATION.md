# STEP 13 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Inventory Cost/FIFO & Reservation Foundation**
...
Preserve FIFO cost lineage and reservation behavior used by checkout and profit.
...
- database/migrations/0008_inventory_engine.sql
- src/modules/inventory/domain/inventory-math.ts
- src/modules/inventory/
- test/inventory-domain.spec.ts

## Verification

FIFO, insufficient-cost fail-closed, reservations and availability assertions passed.
