# STEP 11 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Pricing Administration & Bulk Change Rules**
...
Support controlled bulk pricing with preview-before-apply and auditability.
...
- src/modules/pricing/application/bulk-pricing.service.ts
- src/modules/pricing/application/currency-impact.service.ts
- src/modules/pricing/presentation/pricing.controller.ts
- database/migrations/0007_pricing_engine.sql

## Verification

Build and pricing tests PASS; later regression coverage also exercises preview/apply boundaries.
