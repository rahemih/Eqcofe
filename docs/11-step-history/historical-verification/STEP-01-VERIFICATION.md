# STEP 01 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Product Vision & Scope**
...
Define the Persian-first RTL retail/wholesale coffee-equipment platform and explicit exclusions.
...
- docs/01-product-vision/EQCOFE-PRODUCT-VISION.md
- docs/02-business-rules/EQCOFE-BUSINESS-RULES.md
- README.md

## Verification

Documentary scope is present and internally consistent; this is not runtime behavior.
