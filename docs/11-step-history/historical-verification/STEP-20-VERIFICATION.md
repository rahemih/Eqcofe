# STEP 20 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Refund & Payment Reconciliation**
...
Apply refunds and reconciliation safely without overwriting terminal decisions.
...
- database/migrations/0013_payment_financial_hardening.sql
- src/modules/payments/
- contracts/events/refund.*.schema.json
- test/zarinpal-provider.spec.ts

## Verification

Refund/reconciliation scenarios, including fail-closed partial refund, passed.
