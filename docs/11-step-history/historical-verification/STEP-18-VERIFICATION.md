# STEP 18 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Order Domain**
...
Provide stable auditable order state, snapshots, and lifecycle rules.
...
- src/modules/orders/
- contracts/events/order.*.schema.json

## Verification

Order code/contracts compile and order lifecycle regressions passed in 610/610.
