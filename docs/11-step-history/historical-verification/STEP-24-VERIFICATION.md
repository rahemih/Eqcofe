# STEP 24 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Finance, Cost & Profit Accounting**
...
Calculate integer-Toman COGS/cost/profit and configurable distribution without Wallet semantics.
...
- database/migrations/0019_finance_core.sql through 0025_finance_reporting_exports.sql
- src/modules/finance/
- test/money-toman.spec.ts

## Verification

Finance regression suites and MoneyToman tests passed; no-Wallet policy PASS.
