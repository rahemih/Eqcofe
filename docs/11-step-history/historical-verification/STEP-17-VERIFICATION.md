# STEP 17 — Historical Recovery and Canonical Verification

## Classification

- Reconstructed title: **Checkout Orchestration**
...
Coordinate cart, pricing, inventory, address/customer validations and durable checkout state.
...
- src/modules/cart/application/checkout.service.ts
- test/step37-domain.test.mjs

## Verification

Build and complete regression suite PASS; authoritative integration boundaries are covered by later focused tests.
