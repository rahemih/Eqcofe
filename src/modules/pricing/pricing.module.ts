...
@Module({
  imports:[InventoryModule,ConfigurationModule],controllers:[PricingController],
  providers:[PricingRepository,PricingQueryService,BasePriceService,PriceRuleService,BulkPricingService,CurrencyPricingService,CurrencyImpactService,CurrencyRuleService,ProfitGuardService,InventoryPricingCostBasisAdapter,{provide:PRICING_PUBLIC_PORT,useExisting:PricingQueryService},{provide:PRICING_QUOTE_PORT,useExisting:PricingQueryService},{provide:PRICING_COST_BASIS,useExisting:InventoryPricingCostBasisAdapter}],
  exports:[PricingQueryService,PRICING_PUBLIC_PORT,PRICING_QUOTE_PORT],
